...
export const opinionsData = [
  ...
  {
    id: "op2",
    text: "Świetne studio z luźnym, przyjaznym podejściem – czujesz się, jakbyś był u dobrej znajomej, a jednocześnie wszystko odbywa się w pełni profesjonalnie. Każdy etap jest dokładnie wytłumaczony, szczególnie jak dbać o świeżą dziarkę.Jeśli, tak jak ja, tatuujecie dłonie – przygotujcie się, że będą was za nie długo trzymać! 😂",
  ...
  {
    id: "op3",
    text: "Z całego serca polecam 🩷🩷🩷🩷🩷🩷!!! Super atmosfera, a dziewczyny robią świetną robotę! Przekłucie goi się znakomicie, a w razie pytań i obaw zawsze mogę liczyć na szybką odpowiedź i pomoc 🫶🏻☺️",
    author: "Oliwia Sęcz",
    rate: 5,
    date: "2025-07-22",
  ...
  {
    id: "op4",
    text: "Wspaniała atmosfera i świetne dziewczyn a do tego mega profesjonalne. Od Kari mam wszystkie 8 już tatuaży, a najlepsze, że moja mama przekonała się dzięki nim i sama zrobiła sobie kilka w wieku 60 lat.Robiłam również kolczyki u Emi, szybko sprawnie, profesjonalnie i w cudownym towarzystwie. Polecam!",
